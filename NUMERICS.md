...
the executable, with their notices. [Source correspondence and distribution
materials](licenses/README.md) identify the exact GCC runtime source packages. The Linux amd64 archive requires glibc 2.28
