...
"$reference_python" scripts/compare_sparse_cli.py "$task_root/target/debug/ruspladder" "$probe_root/cache_export_probe" --upstream "$upstream" --work "$check_root/sparse-cli"
"$reference_python" scripts/compare_cache_only.py "$task_root/target/debug/ruspladder" "$probe_root/cache_export_probe" --source "$check_root/sparse-cli/pos-merge" --work "$check_root/cache-only"
"$reference_python" scripts/compare_cache_only.py "$task_root/target/debug/ruspladder" "$probe_root/cache_export_probe" --source "$check_root/sparse-cli/events-C3" --work "$check_root/cache-only-regenerate" --regenerate
